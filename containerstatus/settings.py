...
LOG_DELAY_TIME = env("CONTAINERSTATUS_DELAY_TIME",vtype=timedelta,default=timedelta(seconds=600))# configure in seconds
MAX_ARCHIVE_TIME_PER_LOG = env("CONTAINERSTATUS_MAX_ARCHIVE_TIME_PER_LOG",vtype=int,default=3000)# configure in seconds
