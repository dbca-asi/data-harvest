...
FILE_RE = re.compile(env("RANCHER_FILE_RE",default="(^|/)(ingress-|cronjob-|deployment-|daemonset-|persistentvolumeclaim-|persistentvolume-|namespace-|statefulset-|configmap-).+\.(yaml|yml)$"))
